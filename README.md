...
That file holds your icon order, folders, folder names, and hidden apps. Delete it to reset everything to defaults.
...
- Launchpad!! wannabe
- fancy Zoom-in open animation, zoom-out dismiss animation
...
- Trackpad pinch gesture: thumb + 3 fingers in to open, spread to close (rn conflicts with mac os's)
